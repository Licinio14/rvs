function BDprodutos(){
    ...
    const produtos = [
        ...
        { id: 3, nome: "KNIT WAISTCOAT WITH SCARF DETAIL", preco: 27.99, descricao: "Knit waistcoat with a V-neck, scarf detail and sleeveless design. Ribbed trims. *30% OFF - Price shown includes the discount. *30% OFF - Prices displayed include discounts. *All prices for promotional items already include the discount.",   src: "img/Produtos/1 - Women/1 - Sweaters/3.jpg" },
        ...
        { id: 10, nome: "COTTON TOP", preco: 4.99, descricao: "Sleeveless V-neck top made of 100% spun cotton. *30% OFF - Price shown includes the discount. *30% OFF - Prices displayed include discounts. *All prices for promotional items already include the discount.",   src: "img/Produtos/1 - Women/2 - T-Shirts/10.jpg" },
        ...
        { id: 15, nome: "100% LINEN STRAIGHT TROUSERS", preco: 19.99, descricao: "High-waist trousers made of 100% linen. Featuring an elasticated waistband at the back. Side pockets. Straight-leg design. *30% OFF - Price shown includes the discount. *30% OFF - Prices displayed include discounts. *All prices for promotional items already include the discount.",   src: "img/Produtos/1 - Women/3 - Pants/15.jpg" },
        ...
        { id: 19, nome: "FAUX PATENT SANDALS WITH STRAP", preco: 19.99, descricao: "Faux patent high-heel sandals. Strap across the front. Buckled ankle strap fastening. *30% OFF - Price shown includes the discount. *30% OFF - Prices displayed include discounts. *All prices for promotional items already include the discount.",   src: "img/Produtos/1 - Women/4 - Shoes/19.jpg" },
        ...
        { id: 24, nome: "TEXTURED COTTON SWEATER", preco: 12.99, descricao: "Relaxed fit sweater made of spun cotton fabric. Featuring a round neck, long sleeves and ribbed trims. *30% OFF - Price shown includes the discount. *30% OFF - Prices displayed include discounts. *All prices for promotional items already include the discount.",   src: "img/Produtos/2 - Men/1 - Sweaters/24.jpg" },
        ...
        { id: 38, nome: "LEATHER ESPADRILLES", preco: 22.99, descricao: "Espadrilles made of leather with a split leather finish. Back pull tab for slipping on with ease. Jute-covered sole. *30% OFF - Price shown includes the discount. *30% OFF - Prices displayed include discounts. *All prices for promotional items already include the discount.",   src: "img/Produtos/2 - Men/4 - Shoes/38.jpg" },
